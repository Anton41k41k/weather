...
function updateTempVidget(tempData) {
    ...
    (0, _moduleJs.updateWeatherImg)(weather[0].description, imgCloud);
    setCookie("city", name, {
        secure: true,
        "max-age": 3600
    });
...
async function handleSubmitCity(event) {
    ...
    try {
        ...
        (0, _moduleJs.toStorageNow)(cityNow);
    } catch (error) {
...
function handleAddCityInFollowList() {
    if (listFollowCity.has(cityNow.textContent)) alert("\u042D\u0442\u043E\u0442 \u0433\u043E\u0440\u043E\u0434 \u0443\u0436\u0435 \u0435\u0441\u0442\u044C \u0432 \u0441\u043F\u0438\u0441\u043A\u0435");
    else if (listCity.childElementCount < 5) {
    ...
    (0, _moduleJs.toStorageFollow)(listFollowCity);
}
...
parcelHelpers.export(exports, "toStorageFollow", ()=>toStorageFollow);
parcelHelpers.export(exports, "toStorageNow", ()=>toStorageNow);
parcelHelpers.export(exports, "updateWeatherImg", ()=>updateWeatherImg);
let storageFollowCity;
let currentCity;
function toStorageFollow(object) {
    storageFollowCity = JSON.stringify([
        ...object
    ]);
    localStorage.setItem("follow", storageFollowCity);
}
function toStorageNow(cityNow) {
    currentCity = cityNow.textContent;
    localStorage.setItem("city", currentCity);
}
function updateWeatherImg(object, imgCloud) {
    switch(object){
        case "clear sky":
...
},{}]},["1yfyN","adjPd"], "adjPd", "parcelRequire8fb7")
